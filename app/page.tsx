...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://hzktkqocwjcvewnbkgxo.supabase.co'
const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_bwT8FbETDWdJXWtRbv7D_A_3nvpZ31A'
    ...
    <>
      <nav className="nav">
        ...
        <div className="nav-right">
          <a href="/beta" style={{background:'transparent',color:'var(--mid)',fontFamily:'inherit',fontSize:'.85rem',fontWeight:600,padding:'.5rem 1.1rem',borderRadius:'8px',border:'1.5px solid var(--border)',textDecoration:'none',cursor:'pointer'}}>Atidaryti beta →</a>
